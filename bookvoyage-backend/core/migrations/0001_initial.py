# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-12 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_code', models.CharField(max_length=9, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.CharField(max_length=512)),
                ('location', djgeojson.fields.PointField()),
                ('book_instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ownings', to='core.BookInstance')),
